...
{
    public class LatestFeaturedController : Controller
    {
        // GET: Medicine
        ...
        public ActionResult FProduct1()
        {
            return View();
        }
        public ActionResult FProduct2()
        {
            return View();
        }
        public ActionResult FProduct3()
        {
            return View();
        }
        public ActionResult FProduct4()
        {
            return View();
        }
        public ActionResult FProduct5()
        {
            return View();
        }
        public ActionResult FProduct6()
        {
            return View();
        }
    }
